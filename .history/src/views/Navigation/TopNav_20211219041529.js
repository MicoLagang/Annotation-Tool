    ...
    <>
      <Box sx={{ flexGrow: 1 }} className="mb-4">
        ...
        <Drawer open={open} anchor={"left"} onClose={handleDrawerClose}>
          ...
          <Box sx={{ flexGrow: 1 }} />
          <Button className="text-capitalize" type="button" onClick={installPWA} style={{height:'55px',color: '#272343', backgroundColor: '#ffd803'}}>
                <GetAppIcon style={{minWidth: '56px'}}/> Install iLABEL
              </Button>
          <div>

...
function ImageGrid() {
  ...
  function getAnnotationData() {
    projectFirestore
      ...
      .onSnapshot((querySnapshot) => {
        ...
        setAnnotatedImagesArray([...annotatedImagesArray, parseData.images]);
  ...
  function isAnnotated(doc) {
    console.log(annotatedImagesArray[0]);
    for (let i = 0; i < annotatedImagesArray[0].length; i++) {
      console.log(annotatedImagesArray[i]);

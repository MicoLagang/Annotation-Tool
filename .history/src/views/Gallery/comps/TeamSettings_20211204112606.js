        ...
        <div className="w-100" style={{ maxWidth: "350px" }}>
          <Card style={{ width: "100%" }}>
            <CardContent>
              ...
              <Button className="text-capitalize" onClick={update}>
                Update
              </Button>
            </CardContent>
          </Card>
          ...
          <Card style={{ width: "100%" }}>
            <CardContent>
              ...
              <div>
                <Button className="text-capitalize" onClick={deleteTeam}>
                  Delete
                </Button>
              </div>
            </CardContent>
          ...
          <Card style={{ width: "100%" }}>
            <CardContent>
              ...
              <Button className="text-capitalize" onClick={archiveTeam}>
                Archive
              </Button>
            </CardContent>
          </Card>

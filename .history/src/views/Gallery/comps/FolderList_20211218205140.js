...
function FolderList() {
  ...
  function copyToClickBoard(teamCode) {
    navigator.clipboard.writeText(teamCode)
    alert('Team Code copied to clip board')
  }
    ...
    return (
      <Card style={styles.card}>
        ...
        <div style={styles.overlay}>
          ...
          <Typography style={styles.text}>{updata.TeamCode} <span onClick={copyToClickBoard(updata.TeamCode)}>  <FileCopyIcon/> </span> </Typography>
        </div>
      </Card>
    );
  };

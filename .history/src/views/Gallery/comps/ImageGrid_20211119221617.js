  ...
  function getAnnotationData() {
    projectFirestore
      ...
      .onSnapshot((querySnapshot) => {
        ...
        // annotationData = data[0].data;
        // console.log("Document data:", annotationData);
        let dataFile = new File([data[0].data], "data.json", {
          type: "application/json",
        });
        console.log(dataFile);
        const userInfo = JSON.parse(data[0].data);
        console.log(userInfo);

        // acceptedFiles[0] = dataFile;
        // console.log(acceptedFiles);

        // const importer = new ImporterSpecData[
        //   resolveFormatType(LabelType.POLYGON)
        // ]([LabelType.POLYGON]);

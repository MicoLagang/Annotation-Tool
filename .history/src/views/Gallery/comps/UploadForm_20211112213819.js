...
const UploadForm = () => {
  ...
  async function fetchTotalImages() {
    ...
    await projectFirestore
      ...
      .get()
      .then((snapshot) => {
        setTotalImages(snapshot.data().totalImages);
        totalImagessss = snapshot.data().totalImages;
      });
  }
    ...
    images.map((image) => {
      ...
      uploadTask.put(image).on(
        ...
        async () => {
          ...
          console.log(newTotalImages);
          await setTotalImages(9);
          console.log(totalImages);
          totalImagessss = newTotalImages;
          console.log(totalImagessss);

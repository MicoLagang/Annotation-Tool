...
function ImageGrid() {
  ...
  function getAnnotationData() {
    projectFirestore
      ...
      .onSnapshot((querySnapshot) => {
        ...
        setAnnotatedImagesArray(data[0].data);
        // let parseData = JSON.parse(data[0].data);
        // setAnnotatedImagesArray(parseData);
  ...
  function isAnnotated(doc) {
    ...
    //   console.log(annotatedImagesArray.images[i]);
    ...
    // }
    console.log(annotatedImagesArray);
    // let parseData = JSON.parse(annotatedImagesArray);

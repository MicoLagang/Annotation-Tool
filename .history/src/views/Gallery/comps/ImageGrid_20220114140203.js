...
function ImageGrid() {
  ...
  function updateAcceptReject() {
    setShowReason(false);
    setImageToValidate();
    console.log(isAnnoationAccepted);
    console.log(reason);
    console.log(imageToValidate.id);
          ...
          {imageToValidate && (
            <>
              <div class="btn-group" role="group" aria-label="Basic example">
                <button
                  onClick={() => changeAcceptReject("accept")}
                  type="button"
              ...
              <button onClick={() => updateAcceptReject()}>Submit</button>
            </>
          )}
              ...
              docs.map((doc) => (
                <>
                  ...
                  >
                    <Card
                      key={doc.id}
                      // border={`${doc.isAccepted ? "success" : "danger"}`}
                      border={`
                        ${(() => {
                          if (doc.isAccepted) {
                            return success;
                          } else if (!doc.isAccepted) {
                            return danger;
                          } else {
                            return warning;
                          }

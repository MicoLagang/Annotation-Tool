...
function ImageGrid() {
  ...
  const getImageFolderData = async() => {
    let dataa;
    await teamService.getImageFolderData(teamID, name, folderID).then((data) => {
      ...
      return <Card className="p-3">
          <p>Name: {dataa.data().name}</p>
          <p>Total Images: {dataa.data().totalImages}</p>
        </Card>
  };

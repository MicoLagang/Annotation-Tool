...
function ImageGrid() {
  ...
  useEffect(() => {
    ...
    getAnnotationData();
  }, [imageInfo, totalAnnotatedImages]);
  ...
  function isAnnotated(doc) {
    if (annotatedImagesArray) {
      for (let i = 0; i < annotatedImagesArray.length; i++) {
        for (let index = 0; index < annotatedImagesArray[i].length; index++) {
          ...
          if (doc.name == SliceImageName[0]) {
            unAnnotatedCounter = unAnnotatedCounter + 1;
            return true;
          } else {
            continue;
          }
      ...
      setTotalAnnotatedImages(unAnnotatedCounter);
    ...
    <>
      ...
      <Card style={styles.card}>
        ...
        <div style={styles.overlay}>
          ...
          <Typography style={styles.text}>
            Annotated: {unAnnotatedCounter}
          </Typography>
          <Typography style={styles.text}>
            Annotated: {totalAnnotatedImages}
          </Typography>
        </div>

...
import * as ImporterSpecData from '../../../data/ImporterSpecData';
import { LabelType } from '../../../data/enums/LabelType';
import { AnnotationFormatType } from '../../../data/enums/AnnotationFormatType';
import * as ImportFormatData from '../../../data/ImportFormatData';
    ...
    const loadJSON = () => {
        ...
        .then((doc) => {
            if (doc.exists) {
                ...
                let dataFile = new File([datastring], "data.jpg", {
                ...
                setFormatType(AnnotationFormatType.COCO)
                setLabelType(LabelType.POLYGON)
